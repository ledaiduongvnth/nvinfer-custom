                   ...
                   gint input_height)
{
    ...
    double hdest = input_width * src_height / (double) src_width;
    double wdest = input_height * src_width / (double) src_height;
    guint dest_width, dest_height;

    if (hdest <= input_height) {
    ...
    in_mat =
            cv::Mat (input_height, input_width,
